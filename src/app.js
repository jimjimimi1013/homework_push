...
const CONTACT_MESSAGES = ['😭 결석합니다', '🙇 지각할 것 같아요', '🇨🇳 중국어 잘 하고 싶어요', '✈️ 중국 가고 싶어요', '🧠 단어가 안 외워져요', '😵 오늘 머리가 안 돌아가요', '😶‍🌫️ 아는 단어인데 입에서 안 나와요', '🐌 중국어가 안 늘어요', '📚 공부한 건 많은데 기억이 안 나요', '😎 훗 오늘 공부 좀 했어요', '✅ 숙제 완료!', '🔥 의욕(만) 넘치는 하루', '🧠 단어 외우는 중', '🥳 오늘 수업 너무 재밌고 유익했어요', '🙌 칭찬이 필요한 늙크크..', '😭 중국어가 너무 어려워요', '💪 예습 복습 완료!'];
