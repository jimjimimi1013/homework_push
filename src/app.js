        ...
        React.createElement("div", { className: "flex-1 min-h-0 overflow-y-auto px-4 py-4" },
            ...
            tab === 'contact' && React.createElement(React.Fragment, null,
                React.createElement("div", { className: "mb-4" },
                    React.createElement("h1", { className: "text-[25px] font-black" }, "일하기 싫어서 만들어봤어요 🤦"),
                    React.createElement("p", { className: "mt-1 text-center text-[12px] leading-[19px] text-[#777]" }, "딴짓할 때가 제일 재밌어요. 여러분도 심심할 때 아무거나 보내보세요! 🤭")),
