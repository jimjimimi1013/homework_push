            ...
            tab === 'notifications' && React.createElement(React.Fragment, null,
                ...
                React.createElement("div", { className: "space-y-2" }, myNotices.length ? myNotices.map(n => React.createElement("div", { key: n.id, className: "bg-white rounded-2xl border p-4", style: { borderColor: LIST_BORDER } },
                    React.createElement("div", { className: "flex items-start gap-3" },
                        n.kind === 'contact' ? React.createElement("div", { className: "min-w-0 flex-1 text-left text-[13px] font-medium leading-relaxed whitespace-pre-wrap", style: { color: '#444' } },
                            React.createElement("span", { className: "block" }, n.sender),
                            React.createElement("p", { className: "mt-1" }, n.contactMessage)) : React.createElement("button", { onClick: () => onOpenNotice(n), className: "min-w-0 flex-1 text-left text-[13px] font-medium leading-relaxed whitespace-pre-wrap", style: { color: '#444' } }, n.message),
